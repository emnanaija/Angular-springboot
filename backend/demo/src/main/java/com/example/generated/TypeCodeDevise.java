...
/**
 * <p>Classe Java pour TypeCodeDevise.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * <pre>
 * &lt;simpleType name="TypeCodeDevise"&gt;
 ...
 * 
 */
@XmlType(name = "TypeCodeDevise")
@XmlEnum
public enum TypeCodeDevise {
    ...
    public static TypeCodeDevise fromValue(String v) {
        return valueOf(v);
    }
